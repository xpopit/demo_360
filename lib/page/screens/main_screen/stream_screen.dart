...
class _CameraHomeState extends State<CameraHome> with WidgetsBindingObserver {
  ...
  TextEditingController _textFieldController = TextEditingController(
      text:
          "rtmps://live-api-s.facebook.com:443/rtmp/245453803735772?s_bl=1&s_ps=1&s_psm=1&s_sw=0&s_vt=api-s&a=Abz9HHto-apWlegl");
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
        ...
        builder: (context, AsyncSnapshot<bool> snapshot) {
          // แก้ไข backup
          // final User _u = Provider.of<User>(context);
          // HomeScreenModels _homescreen = Provider.of<HomeScreenModels>(context);
          // return CameraHome();
          // return (_u.getUserData != null || _u.getToken != null)
          //     ? CameraApp()
          //     : RaisedButton(
          //         onPressed: () {
